...
path_embedding_bert = "D:/workspace/pythonMyCode/Keras-TextClassification/keras_textclassification/data/embeddings/chinese_L-12_H-768_A-12/" # path_root + '/data/embeddings/chinese_L-12_H-768_A-12/'
path_embedding_xlnet = path_root + '/data/embeddings/chinese_xlnet_mid_L-24_H-768_A-12/'
path_embedding_albert = "D:/workspace/pythonMyCode/Keras-TextClassification/keras_textclassification/data/embeddings/albert_base_zh/" # path_root + '/data/embeddings/albert_base_zh'
